...
describe('AI Apps Service Page - Metadata', () => {
  describe('Page Metadata Export', () => {
    ...
    it('should have correct page title', () => {
      expect(metadata.title).toBe('Custom AI Application Development & Enterprise AI Solutions | Blaq Digital');
    });
  ...
  describe('OpenGraph Metadata', () => {
    ...
    it('should have correct OpenGraph title', () => {
      expect(metadata.openGraph?.title).toBe('Custom AI Application Development & Enterprise AI Solutions | Blaq Digital');
    });
    ...
    it('should have correct OpenGraph URL', () => {
      expect(metadata.openGraph?.url).toBe('https://blaq.ainative.studio/services/ai-apps');
    });
...
describe('AI Apps Service Page - Schema.org Markup', () => {
  ...
  describe('Service Schema', () => {
    ...
    it('should have correct service URL', () => {
      ...
      if (serviceScript && serviceScript.textContent) {
        const schema = JSON.parse(serviceScript.textContent);
        expect(schema.url).toBe('https://blaq.ainative.studio/services/ai-apps');
      }
    });
  });
